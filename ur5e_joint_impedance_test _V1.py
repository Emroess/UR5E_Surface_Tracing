    ...
    while elapsed < duration_s:
      ...
      if safety_ok:
        if joint_impedance_test:
          ...
          tau_cmd = [joint_stiffness[0] * q_error[0] - joint_damping[0] * joint_speeds[0], joint_stiffness[1] * q_error[1] - joint_damping[1] * joint_speeds[1], joint_stiffness[2] * q_error[2] - joint_damping[2] * joint_speeds[2], joint_stiffness[3] * q_error[3] - joint_damping[3] * joint_speeds[3], joint_stiffness[4] * q_error[4] - joint_damping[4] * joint_speeds[4], joint_stiffness[5] * q_error[5] - joint_damping[5] * joint_speeds[5]]
        elif joint_damping_test:

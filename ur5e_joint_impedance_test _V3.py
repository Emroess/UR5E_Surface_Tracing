...
def build_urscript(
  ...
  zero_torque_test({duration_s:.6f}, {max_torque_values}, {max_torque_rate_values}, {max_tcp_force_n:.6f}, {max_tcp_torque_nm:.6f}, {sample_period_s:.6f}, {log_state}, {damping_test}, {impedance_test}, {joint_damping_values}, {joint_stiffness_values})
end
"""
